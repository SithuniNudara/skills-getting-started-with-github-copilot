...
activities = {
    ...
    "Soccer Club": {
        "description": "Build endurance and skills through soccer practice and matches",
    ...
    "School Band": {
        "description": "Perform music together and develop instrumental skills",
        "schedule": "Tuesdays and Thursdays, 3:15 PM - 4:45 PM",
        "max_participants": 25,
        "participants": ["amelia@mergington.edu", "elijah@mergington.edu"]
    },
    "Robotics Club": {
        "description": "Design, build, and program robots for fun and competition",
